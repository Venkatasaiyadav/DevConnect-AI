    ...
    <main className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-950 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full space-y-8 p-10 bg-slate-900/60 backdrop-blur-xl rounded-3xl shadow-2xl border border-slate-700/50 relative z-10">
        ...
        <div className="flex flex-col items-center">
          <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-400 to-purple-500 shadow-lg shadow-sky-500/20 mb-4">
          ...
          <p className="mt-3 text-center text-sm text-slate-400">
            Sign in to continue to <span className="text-sky-400 font-semibold">DevConnect AI</span>
          </p>
        </div>
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-slate-900/60 text-slate-500 text-xs uppercase tracking-wider font-semibold">Or continue with</span>
            </div>
          </div>
